...
Node *takeinput()
{
    ...
    int pos;
    cout << "Last node is connected to node at postion:" << endl;
    cin >> pos;
...
6.They are also used for things like streaming video. The server sends chunks of videos and sound at unpredictable rates, another chunk of video appears that’s a second or so long.
